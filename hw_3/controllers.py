...
def add():
    ...
    # if a post request satisfies requirements 
    if form.accepted: 
        redirect(URL('index'))
    
    # this is a GET or a POST with errors so return the form
    return dict(form=form)

# the endpoint will be used for URLs of the form /edit/k where k = bird id
